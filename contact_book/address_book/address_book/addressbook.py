...
class AddressBook(UserList):
    ...
    def add(self, record):
        ...
        logging.info(f"record {record.name} added")
    ...
    def edit(self, name, parameter, new_value):
        for contact in self.data:
            if contact["name"] == name:
                ...
                logging.info(f"record {name} edited")
                break
            else:
                continue
        ...
        for contact in self.data:
            if name == contact["name"]:
                ...
                if delta_days.days >= 0:
                    print(
                        Fore.MAGENTA
                        + f"  {delta_days.days} days left until {name}'s birthday"
                    )
                else:
        ...
        for key in self.data:
            if key["name"] == name:
                ...
                if del_contact == "y":
                    ...
                    logging.info(f'record {key["name"]} deleted')
                    break
                else:
                    break
        else:
    ...
    def save(self, file_name):
        ...
        logging.info("address book saved")
    ...
    def load(self, file_name):
        try:
            ...
            if empty_ness.st_size != 0:
                ...
                logging.info("address book loaded")
        except FileNotFoundError:
            with open(file_name, "wb+") as file:
                pickle.dump(self.data, file)
            print(Fore.RED + "\n  address book created")
            logging.info("address book created")
    ...
    def __init__(self, value=""):
        while True:
            ...
            try:
                ...
                logging.info(f"incorrect  number")
    ...
    def __init__(self, value=""):
        while True:
            ...
            try:
                ...
                logging.info(f"incorrect  birthday")
    ...
    def __init__(self, value=""):
        while True:
            ...
            try:
                ...
                logging.info(f"incorrect  email")
    ...
    def __init__(self, value=""):
        while True:
            ...
            try:
                ...
                logging.info("incorrect address")
    ...
    def handle(self, command):
        try:
            if command == "1":
                ...
                print(
                    Fore.GREEN
                    + "  parameter to find (name, phone, birthday, address, note)"
                )
                ...
                print(
                    Fore.GREEN
                    + "  enter the parameter to edit(name, phone, birthday, address, note)"
                )
                parameter = input(Fore.BLUE + "  >>>: ")
                ...
                while True:
                    ...
                    if clear_all == "y":
                        ...
                        logging.info("address book cleared")
                        break
                    else:
                        break
