from Programme.Interface.PrintAnimal import print_animal
from Programme.RegistryManagement.Counter import Counter
from Programme.RegistryManagement.GettingNewAnimal import GettingAnimal
from Programme.RegistryManagement.TeachAnimalNewCommands import TeachAnimalNewCommands
                                        ...
                                        if type_selection.isdigit():
                                            match int(type_selection):
                                                case 1:
                                                    ...
                                                    new_animal = GettingAnimal(type_animal, choose_name,
                                                                               choose_birth_date,
                                                                               choose_command)
                                                    new_animal.domestic_new_animal(config, count)
                                            ...
                                            match int(type_selection):
                                                case 1:
                                                    ...
                                                    new_animal = GettingAnimal(type_animal, choose_name,
                                                                               choose_birth_date,
                                                                               choose_command)
                                                    new_animal.pack_new_animal(config, count)
                                                    new_animal.print_animal()
                                                case 2:
                                                    type_animal = 2
                                                    choose_name = input('Enter the name of the animal: ')
                        ...
                        if item.isdigit():
                            match int(item):
                                case 1:
                                    ...
                                    new_command = TeachAnimalNewCommands(comm)
