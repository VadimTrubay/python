...
#
# class Developer:
#     def __init__(self, name=None, phone=None, city=None, skill=None, rate=None):
#         self.name = name
#         self.phone = phone
#         self.city = city
#         self.skill = skill
...
#
# user = Developer()
# print(user.name, user.phone, user.city, user.skill, user.rate)
# user1 = Developer(name='Vlad', phone='+380631234570', rate=1000)
# print(user1.name, user1.phone, user1.city, user1.skill, user1.rate)
#
# class Developer:
