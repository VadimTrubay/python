...
from Programme.MySQLDB.MySQLQueries import *


def create_database_human_friends(config):
    ...
    try:
        with connect(
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute(create_table_domestic_animals)
                ...
                cursor.execute(insert_domestic_animals_query)
